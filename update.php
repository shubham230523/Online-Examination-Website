...
if(@$_GET['fdid'] && $_SESSION['key']=='shubham123') {
$id=@$_GET['fdid'];
...
//delete user
if(isset($_SESSION['key'])){
if(@$_GET['demail'] && $_SESSION['key']=='shubham123') {
$demail=@$_GET['demail'];
...
if(isset($_SESSION['key'])){
if(@$_GET['demail1'] && $_SESSION['key']=='shubham123') {
...
//remove quiz
if(isset($_SESSION['key'])){
if(@$_GET['q']== 'rmquiz' && $_SESSION['key']=='shubham123') {
$eid=@$_GET['eid'];
...
//add quiz
if(isset($_SESSION['key'])){
if(@$_GET['q']== 'addquiz' && $_SESSION['key']=='shubham123') {
$name = $_POST['name'];
...
//add question
if(isset($_SESSION['key'])){
if(@$_GET['q']== 'addqns' && $_SESSION['key']=='shubham123') {
$n=@$_GET['n'];
$eid=@$_GET['eid'];
$ch=@$_GET['ch'];
...
else if( $_SESSION['key']!='shubham123')
{
...
$sun=$sun-$s;
//updating the rank with new score after subtracting the older score
